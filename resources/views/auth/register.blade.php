...
<body class="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/20 flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="absolute -top-32 -right-32 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl animate-float"></div>
    <div class="absolute -bottom-32 -left-32 w-96 h-96 bg-indigo-400/10 rounded-full blur-3xl animate-float-reverse"></div>
    <div class="absolute top-1/3 right-1/4 w-64 h-64 bg-emerald-300/5 rounded-full blur-3xl animate-float"></div>
    ...
    <div class="w-full max-w-md animate-fade-in-up" style="animation-delay: 0.1s;">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 font-medium">Daftar untuk mulai memesan tiket event</p>
        </div>
        ...
        <div class="glass rounded-3xl border border-white/60 shadow-xl shadow-slate-200/50 p-8">
                ...
                <div class="mb-6 p-4 bg-rose-50 border border-rose-200 rounded-2xl">
                    <ul class="space-y-1">
                        @foreach($errors->all() as $error)
                            <li class="flex items-center gap-2 text-rose-700">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <!-- Nama -->
                <div>
                    <label for="name" class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Nama Lengkap</label>
                    <div class="relative">
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block text-sm font-bold text-slate-700 mb-2 uppercase tracking-wide">Konfirmasi Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center">
                <p class="text-slate-500 font-medium">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-indigo-600 font-bold hover:text-indigo-700 hover:underline underline-offset-4 transition">
                        Masuk di sini
                    </a>
                </p>
            </div>
