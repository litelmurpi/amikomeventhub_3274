...
@section('description')
    {{ isset($exception) && $exception->getMessage() ? $exception->getMessage() : 'Kami sedang melakukan pemeliharaan sistem rutin demi meningkatkan kualitas layanan. Kami akan segera kembali.' }}
@endsection
