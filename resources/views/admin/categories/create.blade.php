...
@section('content')
    <header class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 md:mb-10">
        <div>
            <h1 class="text-2xl sm:text-3xl font-black">Tambah Kategori</h1>
            <p class="text-slate-500 text-sm sm:text-base font-medium">Tambahkan kategori baru untuk event.</p>
        </div>
