...
<main class="flex-1 p-10 overflow-y-auto">
    <header class="mb-10">
        ...
        <p class="text-slate-500 font-medium">Ubah informasi partner atau perbarui logo partner.</p>
    </header>
    ...
    <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden p-8 max-w-2xl">
        <form action="{{ route('admin.partners.update', $partner->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Logo Preview -->
            <div class="space-y-2">
                <span class="block font-black text-slate-700">Logo Saat Ini</span>
                <div class="w-24 h-24 rounded-2xl border border-slate-100 bg-white p-2 flex items-center justify-center overflow-hidden shadow-sm">
            ...
            <div class="space-y-4 border-t pt-4">
                <h3 class="font-black text-slate-700">Perbarui Logo Partner</h3>
                ...
                <div class="p-5 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                    <label for="logo" class="block font-bold text-slate-700">Opsi A: Unggah Berkas Logo Baru</label>
                ...
                <!-- Opsi 2: Input URL -->
                <div class="p-5 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                    <label for="logo_url" class="block font-bold text-slate-700">Opsi B: Masukkan URL Logo Baru</label>
            ...
            <div class="pt-6 border-t flex justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 transition">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</main>
