            ...
            <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
                ...
                <div class="mt-8 pt-6 border-t space-y-3">
                    ...
                    <div class="flex justify-between text-2xl font-black mt-4 pt-4 border-t">
                        ...
                        <span class="text-indigo-600">Rp {{ number_format($event['price_value'] - 5000, 0, ',', '.') }}</span>
                    </div>
                </div>
            </div>
    ...
    <div id="midtrans-overlay"
        ...
        <div class="bg-white w-full max-w-sm rounded-[2rem] overflow-hidden shadow-2xl animate-bounce-in">
            ...
            <div class="p-8 text-center">
                ...
                <h2 class="text-3xl font-black text-indigo-700 my-2">Rp {{ number_format($event['price_value'] - 5000, 0, ',', '.') }}</h2>
                <p class="text-xs text-slate-400">Order ID #{{ $event['id'] }}</p>
